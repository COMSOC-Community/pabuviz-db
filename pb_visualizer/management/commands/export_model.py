...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument('-f', nargs='?', default="", type=str, help='the prefix for the file path')

    def handle(self, *args, **options):
        if not options['m']:
            print("ERROR: you need to pass a model as input using arugment -m <MODEL_NAME>.")
            return
