# Generated by Django 4.2.1 on 2023-08-25 13:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_priority', models.IntegerField()),
                ('applies_to', models.ManyToManyField(related_name='rule_result_metadata', to='pb_visualizer.votetype')),
            ],
            options={
                'ordering': ['order_priority', 'name'],
            },
        ...
        migrations.AddField(
            model_name='rule',
            name='applies_to',
            field=models.ManyToManyField(related_name='rules', to='pb_visualizer.votetype'),
        ),
        migrations.AddField(
            model_name='rule',
            name='rule_family',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='elements', to='pb_visualizer.rulefamily'),
        ),
        migrations.AddField(
            model_name='project',
            name='targets',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('inner_type', models.CharField(choices=[('int', 'integer'), ('float', 'float'), ('list[float]', 'list of floats')], max_length=50)),
                ('order_priority', models.IntegerField()),
                ('applies_to', models.ManyToManyField(related_name='election_metadata', to='pb_visualizer.votetype')),
            ],
            options={
                'ordering': ['order_priority', 'name'],
            },
        ...
        migrations.AddField(
            model_name='election',
            name='vote_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='elections', to='pb_visualizer.votetype'),
        ),
        migrations.AddField(
            model_name='category',
            name='election',
