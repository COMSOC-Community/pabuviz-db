...
class AddElectionTestCase(TestCase):
    ...
    def test_ordinal_example(self):
        ...
        assert(PreferenceInfo.objects.get(voter=voter, project=project).preference_strength == 3)
    ...
    def test_cumulative_example(self):
        ...
        assert(PreferenceInfo.objects.get(voter=voter, project=project).preference_strength == 2)
